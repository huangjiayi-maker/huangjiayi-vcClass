...
BEGIN_MESSAGE_MAP(CZHView, CRecordView)
	...
	ON_COMMAND(ID_search, &CZHView::Onsearch)
	ON_COMMAND(ID_sort, &CZHView::Onsort)
	ON_COMMAND(ID_remenber, &CZHView::Onremenber)
END_MESSAGE_MAP()
